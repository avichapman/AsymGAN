...
class BaseModel(ABC):
    ...
    def __init__(self, opt):
        ...
        Then, you need to define four lists:
            ...
            -- self.optimizers (optimizer list):    define and initialize optimizers. You can define one optimizer for
                                                    each network. If two networks are updated at the same time, you can
                                                    use itertools.chain to group them. See cycle_gan_model.py for an
                                                    example.
        """
        self.opt = opt
    ...
    def set_input(self, input_data: dict):
        ...
        Parameters:
            input_data (dict): includes the data itself and its metadata information. [A, B, A_paths, B_paths]
        """
        pass
