...
def define_generator(input_nc: int, output_nc: int, ngf: int, architecture_name: str,
    ...
    Parameters:
        ...
        architecture_name (str) -- the architecture's name: resnet_9blocks | resnet_6blocks | unet_256 | unet_128
    ...
    if architecture_name == 'resnet_9blocks':
        ...
        raise NotImplementedError('Generator model name [%s] is not recognized' % architecture_name)
    return init_net(net, init_type, init_gain, gpu_ids)


def define_discriminator(input_nc: int, ndf: int, architecture_name: str, n_layers_d: int = 3, norm: str = 'batch',
                         init_type: str = 'normal', init_gain: float = 0.02, gpu_ids: list = []):
    """Create a discriminator

    Parameters:
        input_nc (int)          -- the number of channels in input images
        ndf (int)               -- the number of filters in the first conv layer
        architecture_name (str) -- the architecture's name: basic | n_layers | pixel
...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc: int, output_nc: int, ngf: int = 64, norm_layer=nn.BatchNorm2d,
                 use_dropout: bool = False, n_blocks: int = 6, padding_type: str = 'reflect'):
        """Construct a Resnet-based generator
